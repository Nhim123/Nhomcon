          ...
          <div onClick={handleNav} className='block md:hidden'>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[100%] h-full border-r border-r-gray-900 bg-[#f3ba40]' : 'fixed left-[-100%]'}>
              <ul className='uppercase p-4'>
                <li onClick={handleNav} className='p-4 border-b border-gray-600'><a href='/'>Home</a></li>
                <li onClick={handleNav} className='p-4 border-b border-gray-600'><a href='/about'>About</a></li>
                <li onClick={handleNav} className='p-4 border-b border-gray-600'><a href='/services'>Services</a></li>
                <li onClick={handleNav} className='p-4 border-b border-gray-600'><a href='/contact'>Contact Us</a></li>
              </ul>
            </div>
          </div>
        </div>
