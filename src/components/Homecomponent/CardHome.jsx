  ...
  return (
    <div className='mx-auto max-w-[1240px] '>
      ...
      <div className='grid grid-cols-3 space-x-5'>
        ...
        <div className='pl-20'>
            <img src={Rocket} alt="Tailored Team" className='w-32 h-32'/> {/* This is a placeholder for the first card image */}
          </div>
      ...
      <div className='grid grid-cols-3 space-x-5 py-10'>
        ...
        <div className='justify-start font-Nunito space-y-5'>
          <p className='text-2xl text-Blue1 font-bold'>Quick Scalability</p>
          <h1 className='w-80 text-justify text-lg leading-8'>CAll of the Sunbytes staff are required to sign NDA before starting work on any projects</h1> {/* This is a placeholder for the first card content */}
        </div>
      </div>
    </div>
  )
